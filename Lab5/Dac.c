...
// SSI0Clk (SCLK, pin 4) connected to PF2
// SSI0Fss (!CS, pin 2) connected to PF3
// SSI0Tx (DIN, pin 3) connected to PF1
...
void DAC_InitRaw(void){
  ...
  GPIO_PORTD_AFSEL_R |= 0x09;     // enable alt funct on PF2,1, regular GPIO on PF3
  GPIO_PORTD_DEN_R |= 0x0B;       // configure PF2,1 as SSI, PF3 is regular GPIO
	GPIO_PORTD_DIR_R |= 0x0B;				// PD1,2,3 out
  ...
  SSI1_CR0_R |= 0xCF;             // DSS = 16-bit data
